...
@section('meta-title')
  <meta charset="utf-8" />
  <title>Elitesan | Sanitização de Ambientes | Sanitização de cinemas e teatros</title>
  <meta name="keywords" content="sanitização de ambientes, sanitização de cinemas, sanitização de teatros" />
  <meta name="description" content="Texto sobre como é feita a sanitização em cinemas e teatros." />
...
@section('top-banner')
  ...
  -->
  <section class="page-header page-header-xlg parallax parallax-3" style="background-image:url('{{asset("assets/images/locais-de-aplicacao/parallax/cinema.jpg")}}')">
  	<div class="overlay dark-2"><!-- dark overlay [1 to 9 opacity] --></div>

  	<div class="container">
      <h1 class="size-30 bold margin-bottom-25 wow bounceInLeft"><span class="bg-black-alpha-08 padding-10 text-white">SANITIZAÇÃO DE CINEMAS E TEATROS</span></h1>
  		<span class="wow fadeInLeftBig animation-visible animated font-lato size-18 weight-300 is-primary-color bg-white-alpha-08 padding-10" data-wow-delay="0.4s">Limpeza e saúde também fazem parte da diversão e  entretenimento!</span>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1">
					...
					<img class="pull-left" src="{{asset('assets/images/locais-de-aplicacao/icones/cinema.png')}}" alt="Sanitização de Cinemas e Teatros" />

					<div class="heading-title">
						<h2>Sanitização de Cinemas e Teatros</h2>
					</div>

          <p class="justify">O serviço de <span class="is-primary-color bold">sanitização de cinemas e teatros</span> é
            uma etapa essencial para garantir a limpeza, higiene e saúde dos espectadores.</p>
          <p class="justify">Locais com circulação intensa de pessoas sempre precisam de muito cuidado.
            Essa atenção deve ser redobrada quando se soma a estes ambientes estruturas de madeira e carpete
            que juntam poeira e micro-organismos que tendem a acumular mofo. Para evitar os possíveis prejuízos à saúde.
            </p>
            <p class="justify">A <span class="is-primary-color bold">Elitesan</span> traz como solução o serviço de sanitização de cinemas, auditórios e teatros.</p>
        </div>
				...
				<div class="row margin-top-60">
						...
						<div class="col-sm-3">
							<div class="heading-title heading-border-bottom heading-color">
								<h3>A Importância</h3>
								<p class="is-primary-color">Por que sanitizar cinemas e teatros?</p>
							</div>

              <p class="size-14 justify">Com a alta rotatividade de clientes que utilizam o ambiente, faz-se necessária
                ...
                <li><i class="fa fa-check text-info"></i> Possibilidade de utilização do ambiente duas horas após o término do procedimento de sanitização.</li>
						...
						<div class="col-sm-5">
							<div class="heading-title heading-border-bottom heading-color">
								...
								<p class="is-primary-color">Como é feita a Sanitização nos Cinemas e Teatros?</p>
							</div>

              <p class="size-14 justify">O processo de sanitização de cinemas e teatros é realizado basicamente seguindo os procedimentos básicos

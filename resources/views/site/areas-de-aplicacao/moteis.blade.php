...
@section('meta-title')
  <meta charset="utf-8" />
  <title>Elitesan | Sanitização de Ambientes | Sanitização de motéis</title>
  <meta name="keywords" content="sanitização de ambientes, sanitização de motéis, sanitização em motéis" />
  <meta name="description" content="Texto sobre como é feita a sanitização em motéis." />
...
@section('top-banner')
  ...
  -->
  <section class="page-header page-header-xlg parallax parallax-3" style="background-image:url('{{asset("assets/images/locais-de-aplicacao/parallax/motel.jpg")}}')">
  	<div class="overlay dark-2"><!-- dark overlay [1 to 9 opacity] --></div>

  	<div class="container">
      <h1 class="size-30 bold margin-bottom-25 wow bounceInLeft"><span class="bg-black-alpha-08 padding-10 text-white">SANITIZAÇÃO DE MOTÉIS</span></h1>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1">
					...
					<img class="pull-left" src="{{asset('assets/images/locais-de-aplicacao/icones/motel.png')}}" alt="Sanitização de Motéis" />

					<div class="heading-title">
						<h2>Sanitização de Motéis</h2>
					</div>


          <p class="justify">Um ambiente limpo e bem cuidado é uma preocupação recorrente em motéis, afinal os hábitos de limpeza rigorosos e
            controle de qualidade são fatores decisivos na hora da seleção por parte do cliente. Como a qualidade do serviço é diretamente
            ligada a esse quesito, a <span class="is-primary-color bold">sanitização de motéis</span> se torna uma necessidade básica.</p>
        </div>
				...
				<div class="row margin-top-60">
						...
						<div class="col-sm-3">
							<div class="heading-title heading-border-bottom heading-color">
								<h3>A Importância</h3>
								<p class="is-primary-color">Por que sanitizar motéis?</p>
							</div>

              <p class="size-14">Ácaros, fungos, vírus e bactérias podem causar doenças e alergias;</p>
              <p class="size-14">Higienização eficiente;</p>
              <p class="size-14">Preservação da saúde e limpeza dos quartos;</p>
            ...
            <div class="col-sm-4">
							<div class="heading-title heading-border-bottom heading-color">
								<h3>As Vantagens</h3>
								<p class="is-primary-color">Vantagens da Sanitização de motéis</p>
							</div>
              ...
              <ul class="list-unstyled list-icons">
                ...
                <li><i class="fa fa-check text-info"></i> Diferencial competitivo para o motel que coloca a saúde do cliente como uma preocupação essencial;</li>
                ...
                <li><i class="fa fa-check text-info"></i> Possibilidade de agendamento da sanitização de motéis de acordo com os horários disponíveis do cliente;</li>
                ...
                <li><i class="fa fa-check text-info"></i> Possibilidade de utilização dos ambientes tratados duas horas após o término do procedimento de sanitização.</li>
						...
						<div class="col-sm-5">
							<div class="heading-title heading-border-bottom heading-color">
								...
								<p class="is-primary-color">Como é feita a Sanitização em motéis?</p>
							</div>

              <p class="size-14 ">O processo de sanitização de motéis é realizado basicamente seguindo os procedimentos básicos
